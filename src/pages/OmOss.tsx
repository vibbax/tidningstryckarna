        ...
        <div className="grid md:grid-cols-12 gap-6 md:gap-0">
          <div className="md:col-span-5 md:pr-8">
            <div className="rule-top mb-4">
              <span className="dateline">{t("intro", "dateline", "Vårt team")}</span>
            </div>
            <p className="drop-cap font-body text-sm text-foreground leading-[1.8]">
              {t("intro", "text1", "TidningsTryckarna på Åland Ab är ett helägt dotterbolag inom ÅTT-koncernen med tryckeriverksamhet i Mariehamn. Vi är ett tight team med kompetens inom många olika områden i branschen.")}
            </p>
            <p className="font-body text-sm text-ink-mid leading-[1.8] mt-4">
              {t("intro", "text2", "De flesta av oss har jobbat tillsammans i över 15 år vilket har skapat ett effektivt arbetsflöde.")}
            </p>

            <div className="mt-8 pt-6 border-t border-border">
              <div className="rule-top mb-4">
                <span className="dateline">{t("equipment", "dateline", "Utrustning")}</span>
              </div>
              <p className="font-body text-sm text-ink-mid leading-[1.8]">
                {t("equipment", "text", "Teamet i kombination med vår tryckpress av märket Goss Community ser till att vi kan erbjuda våra kunder bra kapacitet och hög tidningskvalitet året runt. Vi har dessutom öppet 6 dagar i veckan.")}
              </p>
            </div>
          </div>
